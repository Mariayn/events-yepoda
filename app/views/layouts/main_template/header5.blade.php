<nav class="navbar navbar-expand-lg navbar-light bg-light"><!--prueba de un nav con toggler-->
  <div class="container-fluid">
    <a href="{{PATH_LOCALHOST}}viewEvents" class="navbar-brand">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{PATH_LOCALHOST}}viewEvents">Explorar eventos</a>
        </li>
