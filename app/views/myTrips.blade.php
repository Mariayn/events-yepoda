...
@section('body')
    ...
    <div class="container">
        ...
        <a href="{{PATH_LOCALHOST}}userProfile" class="nav-link col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
            > Volver
        </a>
        </header>    
        ...
        <div class="row  justify-content-center mt-2">
            ...
            <div class="col-10"><!--este div tiene que ser un grip de columnas para q muetsre los viajes-->
                ...
                <div class="card">
                    ...
                    <div>
                                <a href="{{PATH_LOCALHOST}}userTrip/deleteTrip/<?php echo $getActiveTrips[$i]['id'];?>" class="card-link text-decoration-none">Eliminar <i class="fa-solid fa-trash"></i></a>
                    </div>
